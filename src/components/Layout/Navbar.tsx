...
import { Menu, X, Globe, Users, Calendar, BookOpen, Camera, Phone, Building, Award, Home } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center space-x-3 flex-shrink-0">
            <img 
              src="/images/profile-pictures/kmun.jpg" 
              alt="KMUN Logo" 
              className="w-10 h-10 rounded-lg object-cover border-2 border-primary/20"
            />
            <div className="hidden sm:block">
              <h1 className="text-xl font-bold text-primary font-playfair">KMUN25</h1>
               <p className="text-xs text-muted-foreground">25th Session</p>
